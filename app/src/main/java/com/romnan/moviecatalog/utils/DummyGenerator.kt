...
object DummyGenerator {
    fun getPopularMovies(): ArrayList<PopularMovie> {
        ...
        movies.add(
            PopularMovie(
                635780,
                "/8GVpIEBqlRBvx28G0LfEX0U8D2k.jpg",
    ...
    fun getPopularTvSeries(): ArrayList<PopularTvSeries> {
        val tvSeries = ArrayList<PopularTvSeries>()
        ...
        tvSeries.add(
            PopularTvSeries(
                85552,
                "/5mi3aRl16yKmfpQJMzvqN5TXkdA.jpg",
                "Euphoria",
                "2019-06-16",
        ...
        tvSeries.add(
            PopularTvSeries(
                83851,
                "/3tDbJxobPN3EI2bBebL6zmusmw5.jpg",
                "The Undoing",
                "2020-10-25",
    ...
    fun getTvSeriesDetail(): TvSeriesDetail = TvSeriesDetail(
        82856,
        "/sWgBv7LV2PRoQgkxwlibdGXKz1S.jpg",
